                ...
                {contactInfo.map((item, index) => (
                  <div key={index} className="flex items-start">
                    ...
                    <div>
                      ...
                      <a
                        href={item.link}
                        className={`hover:text-cyan-500 transition-colors duration-300 ${darkMode ? 'text-gray-300' : 'text-gray-600'
                          }`}
                      >
                        {item.value}
                      </a>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <input
                      ...
                      maxLength={50}
                      required
                      className={`w-full px-4 py-3 rounded-lg focus:outline-none ${darkMode
